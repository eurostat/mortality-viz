...
The material hereby aims at reproducing the results of the Ricciato's preliminary study on 2020 mortality data from ISTAT (see [below](#References)).
...
* Ricciato F. (2020): [A preliminary view at 2020 mortality data from ISTAT](https://ec.europa.eu/eurostat/cros/content/preliminary-view-2020-mortality-data-istat).
