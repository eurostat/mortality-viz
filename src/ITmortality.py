...
# METAFILEITMORT  = '../metadata/ITmetadata-original-comune_giorno.json'
METAFILEITMORT  = '../metadata/ITmetadata-updated-comuni_giornaliero.json'
METAFILEITGEO   = '../metadata/ITmetageo.json'
